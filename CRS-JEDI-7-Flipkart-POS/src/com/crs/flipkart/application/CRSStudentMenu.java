...
public class CRSStudentMenu {
	 ...
	 * @param studentId
	 */
	private  void viewGradeCard(int studentId,int semesterId) {
		// TODO Auto-generated method stub
	...
	private void paymentByCard(int studentId) {
	...
	private void paymentByCheque(int studentId) {
	...
	private void paymentByNetBanking(int studentId) {
