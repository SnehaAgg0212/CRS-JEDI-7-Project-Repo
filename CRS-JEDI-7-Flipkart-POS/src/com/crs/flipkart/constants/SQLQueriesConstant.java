...
public class SQLQueriesConstant {
	...
	*/
	public static final String GET_COURSES="select professor.professorId, course.courseId, course.courseName, course.courseSeats from course INNER JOIN professor where professorId=?";
